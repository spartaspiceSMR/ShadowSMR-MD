...
`;
  ...
  menu += `
👨‍💻 *DEVELOPERS*
 ┗ @254742215053 (Main Dev)
 ┗ @254742215053 (†💖R🍥Ö💦Ú🔱ß🍷L🥺È Team)

📡 Powered by *†💖R🍥Ö💦Ú🔱ß🍷L🥺È-GLX SYSTEM*
${topDivider}
`;
    ...
    dest,
    {
      ...
      contextInfo: {
        ...
        forwardedNewsletterMessageInfo: {
          ...
          newsletterName: "†💖R🍥Ö💦Ú🔱ß🍷L🥺ÈXtech", // Displayed name
...
async function sendRandomVoiceNote(zk, dest, ms, repondre) {
  const folder = path.join(__dirname, "../†💖R🍥Ö💦Ú🔱ß🍷L🥺È/");
...
function getRandomImageFromFolder() {
  const folder = path.join(__dirname, "..//_images/");
