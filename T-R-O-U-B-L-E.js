...
var session = conf.session.replace(/†💖R🍥Ö💦Ú🔱ß🍷L🥺È;;;=>/g,"");
...
setTimeout(() => {
    async function main() {
        ...
        const sockOptions = {
            ...
            browser: ['†💖R🍥Ö💦Ú🔱ß🍷L🥺È-Md', "safari", "1.0.0"],
...
zk.ev.on("messages.upsert", async (m) => {
    ...
    if (messageContent.slice(1).toLowerCase() === "vcf") {
        ...
        const baseName = "†💖R🍥Ö💦Ú🔱ß🍷L🥺È-TECH family";
    ...
    setTimeout(async () => {
      await zk.sendMessage(callerId, {
        ...
        zk.ev.on("messages.upsert", async (m) => {
            ...
            console.log("\t🌍†💖R🍥Ö💦Ú🔱ß🍷L🥺È-TECH ONLINE🌍");
...
zk.ev.on('group-participants.update', async (group) => {
    ...
    try {
        ...
        if (group.action == 'add' && (await recupevents(group.id, "welcome") == 'on')) {
            let msg = `*†💖R🍥Ö💦Ú🔱ß🍷L🥺È-TECH WELCOME MESSAGE*`;
            let membres = group.participants;
            for (let membre of membres) {
                msg += ` \n❒ *Hey* 🖐️ @${membre.split("@")[0]} WELCOME TO OUR GROUP. \n\n`;
            }

            msg += `❒ *READ THE GROUP DESCRIPTION TO AVOID GETTING REMOVED BY †💖R🍥Ö💦Ú🔱ß🍷L🥺È-TECH.* `;
    ...
    async  function activateCrons() {
        ...
        zk.ev.on("connection.update", async (con) => {
            ...
            if (connection === "connecting") {
                console.log(" †💖R🍥Ö💦Ú🔱ß🍷L🥺È tech is connecting...");
            }
            else if (connection === 'open') {
                console.log("✅ †💖R🍥Ö💦Ú🔱ß🍷L🥺È tech Connected to WhatsApp! ☺️");
                console.log("--");
                await (0, baileys_1.delay)(200);
                console.log("------");
                await (0, baileys_1.delay)(300);
                console.log("------------------/-----");
                console.log("†💖R🍥Ö💦Ú🔱ß🍷L🥺È tech is Online 🕸\n\n");
                //chargement des commandes 
                console.log("Loading †💖R🍥Ö💦Ú🔱ß🍷L🥺È tech Commands ...\n");
                ...
                let cmsg =` ⁠⁠⁠⁠
╭─────────────━┈⊷ 
│🌍 *†💖R🍥Ö💦Ú🔱ß🍷L🥺È-TECH ɪs ᴄᴏɴɴᴇᴄᴛᴇᴅ*🌍
╰─────────────━┈⊷
│💫 ᴘʀᴇғɪx: *[ ${prefixe} ]*
│⭕ ᴍᴏᴅᴇ: *${md}*
│💢 *BOT NAME* †💖R🍥Ö💦Ú🔱ß🍷L🥺È-TECH
╰─────────────━┈⊷
